...
void fft_split_radix_dit_rec(Complex *input, size_t fft_len)
{
    ...
    // 先分别求前半部分和后面的两部分的DIT
    fft_split_radix_dit_rec(input, half_len);
    fft_split_radix_dit_rec(input + half_len, quarter_len);
    fft_split_radix_dit_rec(input + half_len + quarter_len, quarter_len);
...
void fft_split_radix_dif_rec(Complex *input, size_t fft_len)
{
    ...
    fft_split_radix_dif_rec(input, half_len);
    fft_split_radix_dif_rec(input + half_len, quarter_len);
    fft_split_radix_dif_rec(input + half_len + quarter_len, quarter_len);
}
